...
const res = await fetch(url, {
  ...
  body: JSON.stringify({
    ...
    messages: [
      { role: 'system', content: 'You help college students spot scam messages. Reply with ONLY JSON: {"label":"scam"|"legit"|"unsure","explanation":"one plain sentence for a student"}.' },
