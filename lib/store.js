...
function fresh() {
  return { students: {}, ledger: [], events: [], redemptions: [], prices: {} };
}

function normalize(s) {
  const f = fresh();
  return { ...f, ...(s || {}), students: (s && s.students) || {}, ledger: (s && s.ledger) || [], events: (s && s.events) || [], redemptions: (s && s.redemptions) || [], prices: (s && s.prices) || {} };
}
